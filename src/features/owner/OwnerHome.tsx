...
export function OwnerHomePage() {
  ...
  return <>
    ...
    <section className="owner-primary-actions" aria-labelledby="owner-actions-title"><div className="owner-primary-heading"><div><span className="eyebrow">Acciones principales</span><h2 id="owner-actions-title">¿Qué necesitás hacer?</h2></div><span className="muted">Unidad 7B</span></div><div className="owner-primary-grid"><Link to="/demo/propietario/servicios/sum"><CalendarDays size={23} /><span><strong>Reservar el SUM</strong><small>Elegí fecha y turno</small></span><ArrowUpRight size={18} /></Link><Link to="/demo/propietario/edificio/expensas"><FileText size={23} /><span><strong>Ver expensas</strong><small>Liquidación de tu unidad</small></span><ArrowUpRight size={18} /></Link><Link to="/demo/propietario/servicios/reclamos?new=1"><Wrench size={23} /><span><strong>Informar un problema</strong><small>Crear y seguir un reclamo</small></span><ArrowUpRight size={18} /></Link></div></section>
